import{_ as l,C as p,o,c as e,k as n,a as s,H as t,Q as c}from"./chunks/framework.efea9256.js";const C=JSON.parse('{"title":"polyphonic","description":"","frontmatter":{},"headers":[],"relativePath":"use/polyphonic.md","filePath":"use/polyphonic.md"}'),r={name:"use/polyphonic.md"},y={id:"polyphonic",tabindex:"-1"},i=n("a",{class:"header-anchor",href:"#polyphonic","aria-label":'Permalink to "polyphonic <Badge type="tip" text="v3.15.0+" vertical="middle" />"'},"​",-1),E=c(`<p>使用 <code>polyphonic</code> api 来获取多音字的全部读音。</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>大多数情况下你只需要使用 <a href="/qierkang.github.io/pms-doc-html/use/pinyin.html">pinyin</a> api，它会自动识别文本中多音字的正确读音。<code>polyphonic</code> 是用来获取每个字的所有读音的而不是多音字在句子中的正确读音。</p></div><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><h3 id="常规使用" tabindex="-1">常规使用 <a class="header-anchor" href="#常规使用" aria-label="Permalink to &quot;常规使用&quot;">​</a></h3><p>使用 <code>type</code> 属性控制返回值的格式：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { polyphonic } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;pms-doc&#39;</span><span style="color:#E1E4E8;">;</span></span>
